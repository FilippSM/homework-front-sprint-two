...
export const pureAddUser = (name: string, setError: React.Dispatch<React.SetStateAction<string>>, setName: React.Dispatch<React.SetStateAction<string>>, addUserCallback: (name: string) => void) => {
    ...
    if (name.trim() === "") { //защита  от введения пустой строки
...
export const pureOnBlur = (name: string, setError: React.Dispatch<React.SetStateAction<string>>, /* setName: React.Dispatch<React.SetStateAction<string>> */) => { 
